define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'order/loanlog/index',
                    add_url: 'order/loanlog/add',
                    edit_url: 'order/loanlog/edit',
                    details_url: 'order/loanlog/details',
                    priceedit_url: 'order/loanlog/priceedit',
                    del_url: 'order/loanlog/del',
                    multi_url: 'order/loanlog/multi',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'agent_name', title: __('代理商')},
                        {field: 'agent_phone', title: __('代理电话')},
                        {field: 'product_name', title: __('贷款业务')},
                        {field: 'loan_price', title: __('贷款金额')},
                        {field: 'commission', title: __('佣金'), operate: false},
                        ...
                        {field: 'operate', title: __('审核操作'), events: Table.api.events.operate, formatter: Table.api.formatter.operate4},
                    ]
                ]
            });
