...
/*    	console.log(Config)
    	console.log(pColumns);console.log(that)
    	console.log(Config.controllername)
*/
        var htmlForm = [];
        ...
        for (var i in pColumns) {
            ...
            if (!vObjCol.checkbox && vObjCol.field !== 'operate' && vObjCol.searchable && vObjCol.operate !== false) {
                ...
                var controller_status  = true ;
            /*   switch(vObjCol.fieldIndex)
                {
	                case 2:
	                	if(Config.controllername == 'example.agentapply')
	            		{
	        			 htmlForm.push(sprintf('<select><option name="">请选择</option><option name="%s" value="1">申请中</option><option name="%s" value="3">申请失败</option></select>',vObjCol.field,vObjCol.field,vObjCol.field));       
	                ...
	                case 3:
	                	if(Config.controllername == 'example.agentmanage')
	            		{
	        			 htmlForm.push(sprintf('<select><option name="">请选择</option><option name="%s" value="0">特级代理</option><option name="%s" value="1">一级代理</option><option name="%s" value="2">二级代理</option></select>',vObjCol.field,vObjCol.field,vObjCol.field));       
	        			 vObjCol.operate = (typeof vObjCol.operate === 'undefined' || $.inArray(vObjCol.operate, opList) === -1) ? '=' : vObjCol.operate;
	        			 htmlForm.push(sprintf('<input type="hidden" class="form-control operate" name="field-%s" data-name="%s" value="%s" readonly>', vObjCol.field, vObjCol.field, vObjCol.operate));
	        				break;
	            		}
                ...
                if(Config.controllername == 'example.agentapply')
    			{
                	if(vObjCol.fieldIndex == 1)
            		{
                		 continue;
            		}
        			if(vObjCol.fieldIndex == 2)
            		{
        				 controller_status = false;
        				 htmlForm.push(sprintf('<span><b>状态&nbsp;</b></span><select><option name="">请选择</option><option name="%s" value="1">待审核</option><option name="%s" value="2">审核通过</option><option name="%s" value="3">审核失败</option></select>',vObjCol.field,vObjCol.field,vObjCol.field));       
	        			 vObjCol.operate = (typeof vObjCol.operate === 'undefined' || $.inArray(vObjCol.operate, opList) === -1) ? '=' : vObjCol.operate;
	        			 htmlForm.push(sprintf('<input type="hidden" class="form-control operate" name="field-%s" data-name="%s" value="%s" readonly>', vObjCol.field, vObjCol.field, vObjCol.operate));	    
        			 continue;
            		}        			
        			if (vObjCol.fieldIndex == 4)
        			{
            			break;
        			}
    			}
                 ...
                 if(Config.controllername == 'example.agentmanage')
        			{
            			if(vObjCol.fieldIndex == 3)
                		{
            			 controller_status = false;
            			 htmlForm.push(sprintf('<span><b>等级&nbsp;</b></span><select><option name="">请选择</option><option name="%s" value="0">特级代理</option><option name="%s" value="1">一级代理</option><option name="%s" value="2">二级代理</option><option name="%s" value="3">三级代理</option></select>',vObjCol.field,vObjCol.field,vObjCol.field,vObjCol.field));       
            			 vObjCol.operate = (typeof vObjCol.operate === 'undefined' || $.inArray(vObjCol.operate, opList) === -1) ? '=' : vObjCol.operate;
            			 htmlForm.push(sprintf('<input type="hidden" class="form-control operate" name="field-%s" data-name="%s" value="%s" readonly>', vObjCol.field, vObjCol.field, vObjCol.operate));
            			 continue;
                		}
            			 if (vObjCol.fieldIndex == 5)
            			{
                			break;
            			}	
        			}
                 
                 if(Config.controllername == 'example.commissionreport')
     			{
         			if(vObjCol.fieldIndex == 3)
             		{
         				 controller_status = false;
            			 htmlForm.push(sprintf("<div class=\"form-group\" style=\"margin: 5px; position: relative;\"><label for=\"createtime\" class=\"control-label\" style=\"padding:0 10px\">日期：</label><input type=\"hidden\" class=\"form-control operate\" name=\"field-createtime\" data-name=\"createtime\" value=\"BETWEEN\" readonly=\"\"><input type=\"datetime\" class=\"form-control datetimepicker datetimePicker1 start\" name=\"createtime\" value=\"\" placeholder=\"开始时间\" id=\"createtime\" data-date-format=\"YYYY-MM-DD\">&nbsp;-&nbsp;<input type=\"datetime\" class=\"form-control datetimepicker datetimePicker2 end\" name=\"createtime\" value=\"\" placeholder=\"结束时间\" id=\"createtime\" data-date-format=\"YYYY-MM-DD\"></div><div class=\"form-group\" style=\"margin:5px\"><div class=\"col-sm-12 text-center\"></div></div>"));       
            			 vObjCol.operate = (typeof vObjCol.operate === 'undefined' || $.inArray(vObjCol.operate, opList) === -1) ? '=' : vObjCol.operate;
            			 htmlForm.push(sprintf('<input type="hidden" class="form-control operate" name="field-%s" data-name="%s" value="%s" readonly>', vObjCol.field, vObjCol.field, vObjCol.operate));
         			     continue;
             		}
                 ...
                 if(Config.controllername == 'wechat.commissionwithdrawal')
     			{
         			if(vObjCol.fieldIndex == 3)
             		{
         				 controller_status = false;
         				 htmlForm.push(sprintf('<span><b>状态&nbsp;</b></span><select><option name="">请选择</option><option name="%s" value="1">审核中</option><option name="%s" value="2">审核通过</option><option name="%s" value="3">审核失败</option></select>',vObjCol.field,vObjCol.field,vObjCol.field));       
	        			 vObjCol.operate = (typeof vObjCol.operate === 'undefined' || $.inArray(vObjCol.operate, opList) === -1) ? '=' : vObjCol.operate;
	        			 htmlForm.push(sprintf('<input type="hidden" class="form-control operate" name="field-%s" data-name="%s" value="%s" readonly>', vObjCol.field, vObjCol.field, vObjCol.operate));
         			     continue;
             		}        			
                 ...
                 if(Config.controllername == 'client.user')
      			{
          			if(vObjCol.fieldIndex == 1)
              		{
          				 continue;
                 ...
                 if(Config.controllername == 'client.loanproduct')
       			{
           			if(vObjCol.fieldIndex == 1)
               		{
           				 continue;
                 ...
                 if(Config.controllername == 'client.loanflow')
        			{
            			if(vObjCol.fieldIndex == 1)
                		{
            				 continue;
                 ...
                 if(Config.controllername == 'client.bank')
     			{
         			if(vObjCol.fieldIndex == 1)
             		{
         				 continue;
         			...
         			if( vObjCol.fieldIndex ==5 || vObjCol.fieldIndex == 6 || vObjCol.fieldIndex ==7 ||  vObjCol.fieldIndex ==8)
             		{
         				 continue;
             		} 
                 ...
                 if(Config.controllername == 'client.banktype')
      			{
          			if(vObjCol.fieldIndex == 1 || vObjCol.fieldIndex ==2)
              		{
          				 continue;
              		}
                 ...
                 if(Config.controllername == 'client.loan')
       			{
           			if(vObjCol.fieldIndex == 1 || vObjCol.fieldIndex ==3  || vObjCol.fieldIndex ==5  || vObjCol.fieldIndex ==6 || vObjCol.fieldIndex ==7)
               		{
           				 continue;
               		}
                 ...
                 if(Config.controllername == 'client.bankcard')
        			{
            			if(vObjCol.fieldIndex == 1 )
                		{
            				 continue;
                 ...
                 if(Config.controllername == 'order.loanlog')
     			{
         			if(vObjCol.fieldIndex == 1 || vObjCol.fieldIndex ==3 || vObjCol.fieldIndex ==4 || vObjCol.fieldIndex ==5 || vObjCol.fieldIndex ==6 || vObjCol.fieldIndex ==7)
             		{
         				 continue;
             		}
                 ...
                 if(Config.controllername == 'order.bankcardlog')
      			{
          			if(vObjCol.fieldIndex == 1 || vObjCol.fieldIndex ==4 || vObjCol.fieldIndex ==5 ||  vObjCol.fieldIndex ==6 )
              		{
          				 continue;
              		}
                 ...
                 if(Config.controllername == 'strategy.draftbox')
       			{
           			if(vObjCol.fieldIndex == 1 || vObjCol.fieldIndex ==3 || vObjCol.fieldIndex ==4 )
               		{
           				 continue;
               		}
                 ...
                 if(Config.controllername == 'strategy.strategylist')
       			{
           			if(vObjCol.fieldIndex == 1 || vObjCol.fieldIndex ==3 )
               		{
           				 continue;
               		}
           			if(vObjCol.fieldIndex == 4)
       				{
           			// controller_status = false;
        			 htmlForm.push(sprintf('<span><b>攻略分类&nbsp;</b></span><select><option name="">请选择</option><option name="%s" value="0">办卡技巧</option><option name="%s" value="1">贷款攻略</option></select>',vObjCol.field,vObjCol.field,vObjCol.field,vObjCol.field));       
        			 vObjCol.operate = (typeof vObjCol.operate === 'undefined' || $.inArray(vObjCol.operate, opList) === -1) ? '=' : vObjCol.operate;
        			 htmlForm.push(sprintf('<input type="hidden" class="form-control operate" name="field-%s" data-name="%s" value="%s" readonly>', vObjCol.field, vObjCol.field, vObjCol.operate));
        			 continue;
       				}
            ...
            if(controller_status){
                ...
                if (vObjCol.searchList) {
                    ...
                    if (/BETWEEN$/.test(vObjCol.operate)) {
                        ...
                        htmlForm.push(sprintf('<input type="%s" class="%s datetimePicker1" name="%s" value="%s" placeholder="%s" id="%s" %s %s>', type, addclass, vObjCol.field, defaultValueArr[0], placeholder, vObjCol.field, style, data));
                        htmlForm.push(sprintf('&nbsp;-&nbsp;<input type="%s" class="%s datetimePicker2" name="%s" value="%s" placeholder="%s" id="%s" %s %s>', type, addclass, vObjCol.field, defaultValueArr[1], placeholder, vObjCol.field, style, data));
                    } else {
